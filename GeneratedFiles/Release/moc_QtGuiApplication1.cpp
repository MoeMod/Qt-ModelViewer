...
QT_MOC_LITERAL(1, 18, 15), // "updateStatusBar"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 3) // "str"

    },
    "QtGuiApplication1\0updateStatusBar\0\0"
    "str"
};
...
void QtGuiApplication1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtGuiApplication1::updateStatusBar)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void QtGuiApplication1::updateStatusBar(QString _t1)
{
